...
// Arama sonuçlarından (GameAdapter) gameId ile aç
...
// Fırsat kartlarından (DealAdapter) dealId ile aç
...
class ExploreFragment : Fragment() {
    ...
    private val genres = listOf("Trend","RPG","Aksiyon","Strateji","Indie","Yaris","Spor","FPS","Acik Dunya","Korku")
